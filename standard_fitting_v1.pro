...
answer=''
read, answer, prompt='plot profile? (yes or no) '
...
if answer eq 'no' then goto, jump2
plot_fitted_profiles, nu, A

answer1=''
read, answer1, prompt='continue? (yes or no) '
if answer1 eq 'no' then goto, jump1
;stop, ''
jump2:
